...
CONTROL_BAG TCPServer::control_bag;
...
void* TCPServer::Task(void *arg)
{
	...
	while(1)
	{
		...
		if(n != -1) 
		{
			...
			if(n==sizeof(CONTROL_BAG)){
				memcpy((char*)&control_bag, msg, n);
				std::cout << control_bag.type << " " << control_bag.var << std::endl;
				msg[n]=0;
				desc->message = string("hello");
